...
def lbs(betas, pose, v_template, shapedirs, posedirs, J_regressor, parents,
        lbs_weights, pose2rot=True, dtype=torch.float32, additional_scalp_blendshape=None):
    ...
    if additional_scalp_blendshape is not None:
        v_shaped = v_shaped + additional_scalp_blendshape
    # Get the joints
    # NxJx3 array
